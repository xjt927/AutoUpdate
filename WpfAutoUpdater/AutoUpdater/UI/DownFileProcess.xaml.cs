    ...
    public partial class DownFileProcess : WindowBase
    {
        ...
        public DownFileProcess(string callExeName, string updateFileDir, string appDir, string appName, string appVersion, string desc)
        {
            ...
            this.Loaded += (sl, el) =>
            {
                ...
                this.NoButton.Click += (sender, e) => this.Close();
        ...
        public void DownloadUpdateFile()
        {
            ...
            //string url = Constants.WpfAutoUpdateUrl + callExeName + "/update.zip";
            string url = Constants.WpfAutoUpdateUrl + "/update.zip";
                    ...
                    try
                    {
                        f = () =>
                        {
                            ...
                            if (alert.YesBtnSelected)
                            {
                                ...
                                //string serviceVersion = Updater.ServiceVersion;//服务端版本
